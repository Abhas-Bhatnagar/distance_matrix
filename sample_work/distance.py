...
workbook = xlsxwriter.Workbook('output2.xlsx')										#NAME OF GENERATED FILE
worksheet = workbook.add_worksheet()
wb = open_workbook('SKLM_Telugu_new.xlsx')#SKLM_Telugu_new.xlsx														#NAME OF INPUT FILE CONTAINING ONE SHEET
...
def distance(lat_o,lon_o,lat_d,lon_d,row_o,col_d):
	url="http://dev.virtualearth.net/REST/V1/Routes/Walking?wp.0="+str(lat_o)+","+str(lon_o)+"&wp.1="+str(lat_d)+","+str(lon_d)+"&optmz=distance&output=json&key=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
