...
def distance(lat_o,lon_o,lat_d,lon_d,row_o,col_d):
	url="https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins="+str(lat_o)+","+str(lon_o)+"&destinations="+str(lat_d)+","+str(lon_d)+"&mode=walking&key=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
